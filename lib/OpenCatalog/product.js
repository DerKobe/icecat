...
icecat.prototype.getFamily = function() {
  try {
    ...
    if (this.productData.ProductFamily[0].hasOwnProperty('Series')) {
      family.series = {
        id: this.productData.ProductFamily[0].Series[0].Name[0].$.ID,
        name: this.productData.ProductFamily[0].Series[0].Name[0].$.Value
      };
    }
    return family;
  } catch (e) {
